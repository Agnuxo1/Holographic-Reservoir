...
CONFIG = {
    ...
    # Timing parameters
    "step_duration_sec": 45,         # Increased for bridge stabilization
...
class BenchmarkExperiment:
    ...
    def collect_step(self, freq_mhz: int, step_idx: int) -> StepMeasurement:
        """Collect one step of data via Bridge"""
        self.log(f"    🧠 Setting Frequency: {freq_mhz} MHz...")
        self.bridge.inject_seed(f"BENCHMARK_STEP_{step_idx}_{freq_mhz}")
