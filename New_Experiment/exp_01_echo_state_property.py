...
if __name__ == "__main__":
    print("=" * 70)
    print("CHIMERA VALIDATION EXPERIMENT 1")
    print("Echo State Property (Fading Memory) Test")
    print()
    print("This experiment tests whether the ASIC system has the")
    print("'fading memory' property required for reservoir computing.")
    print()
